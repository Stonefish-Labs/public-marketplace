...
| `cloud-apple-calendar` | FastMCP 3.x server for Apple Calendar integration on macOS. | cloud |
| `cloud-apple-reminders` | FastMCP 3.x server for Apple Reminders integration on macOS. | cloud |
